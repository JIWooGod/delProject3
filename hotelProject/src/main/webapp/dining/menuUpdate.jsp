...
<form action="d1menuUpdateAction?no=${ menus.menuNo }" method="POST" id="actionFrm" name="actionFrm" enctype="multipart/form-data">
    <div class="hs_reservation_left">
		...
		<br /><br /><br />
		수정할 이미지<img id="image_section" src="#" alt="" style="width: 200px; height: 200px; margin: 10px" />
    </div>
      ...
      <div class="hs_reservation_right">
        <ul class="hs_reservation_litt">
          <li>
            ...
            <input type="text" id="rstNo" name="rstNo" readonly value="${ menus.rstNo }">
          </li>
          <li>
            <strong style="width: 600px;">메뉴 번호</strong>
            <input type="text" id="" name="menuNo" readonly value="${ menus.menuNo }">
          </li>
          <li>
            <strong style="width: 600px;">메뉴이름</strong>
            <input type="text" id="" name="menuName" value="${ menus.menuName }">
          </li>
          <li>
            <strong style="width: 600px;">메뉴가격</strong>
            <input type="text" id="" name="menuPrice"
            onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="${ menus.menuPrice }">
          </li>
          <li>
            <strong style="width: 600px;">메뉴설명</strong>
            <textarea style="resize: none;" cols="40" rows="5" name="menuCnt">${ menus.menuCnt }</textarea>
          </li>
        </ul>
    ...
    <a href="d1menuList" class="hs_reservation_btn_poin" style="color:#FFFFFF;">목록으로</a>
      <a href="javascript:menuUpdateAction();" class="hs_reservation_btn_poin" style="color:#FFFFFF;">완료</a>
    </div>
